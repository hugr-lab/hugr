...
require (
	...
	github.com/hugr-lab/query-engine v0.3.17
...
require (
	...
	github.com/hugr-lab/query-engine/client v0.3.17 // indirect
	github.com/hugr-lab/query-engine/types v0.3.17 // indirect
