...
require (
	...
	github.com/hugr-lab/query-engine v0.3.23
...
require (
	...
	github.com/hugr-lab/query-engine/client v0.3.23 // indirect
	github.com/hugr-lab/query-engine/types v0.3.23 // indirect
