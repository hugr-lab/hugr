...
require (
	...
	github.com/hugr-lab/query-engine v0.3.15
...
require (
	...
	github.com/hugr-lab/query-engine/client v0.3.15 // indirect
	github.com/hugr-lab/query-engine/types v0.3.15 // indirect
