...
require (
	...
	github.com/hugr-lab/query-engine v0.3.28
...
require (
	...
	github.com/hugr-lab/query-engine/client v0.3.28 // indirect
	github.com/hugr-lab/query-engine/types v0.3.28 // indirect
